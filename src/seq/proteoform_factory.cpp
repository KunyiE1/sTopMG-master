...
ProteoformPtr geneDbProteoformPtr(FastaSeqPtr fasta_seq_ptr, ModPtrVec fix_mod_list, bool need_shift_list) {
...
ProteoformPtrVec readFastaToProteoformPtrVec(const std::string &file_name,
  ...
  while (seq_ptr != nullptr) {
    ProteoformPtr proteo_ptr = geneDbProteoformPtr(seq_ptr, fix_mod_list, need_shift_list);
