...
std::map<std::string, std::string> ToppicArgument::initArguments() {
  ...
  arguments["allowProtMod"] = "NONE";
  arguments["nTermLabelMass"] = "0";
  arguments["useApproxSpectra"]="false";
  arguments["variablePtmNum"] = "5";
  arguments["variablePtmFileName"] = "/home/kunyili/toppic-suite-main/data/variable_mods.txt";
